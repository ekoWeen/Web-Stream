...
<form class="form-basic" method="POST" action="insert_maintenance.php">
...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="Kode_Angka_QR" class="form-control" id="Kode_Angka_QR" placeholder="Masukan kode angka QR">
    </div>
    <div class="form-group">
