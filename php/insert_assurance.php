<?php
    ...
    $sql = "INSERT INTO assurance (Nama_Surveyor, Kode_Angka_QR, Nama_ODP, Port_ODP, No_Telpon_Pelanggan, SN_ONT) VALUES ('$Nama_Surveyor', '$Kode_Angka_QR', '$Nama_ODP', '$Port_ODP', '$No_Telpon_Pelanggan', '$SN_ONT')";
